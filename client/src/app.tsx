    ...
    <div className="container mx-auto -mt-8 max-w-screen-lg space-y-16">
      <form className="space-y-2" onSubmit={handleSubmit(handleSubmitTask)}>
        <div className="flex w-full items-center gap-3">
          <input
            className="w-full rounded-lg border-none bg-zinc-50 p-4 text-lg text-zinc-950 outline-none ring-1 ring-zinc-400 placeholder:text-zinc-500 focus:ring-2 focus:ring-zinc-600 dark:ring-zinc-800 dark:bg-zinc-900"
